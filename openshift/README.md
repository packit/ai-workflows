...
- Ensure secrets exist for the following values:
  ...
  **Important**: Use a fine-grained, expiring token restricted to the required
  repositories with only read permissions. Do not use the classic `public_repo`
  scope: it grants write access to public repositories.
