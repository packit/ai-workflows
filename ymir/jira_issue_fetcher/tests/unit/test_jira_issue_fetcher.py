...
import sys
import time
import ymir.jira_issue_fetcher
...
from ymir.common.models import Task, TriageInputSchema, RebaseInputSchema, BackportInputSchema, RebaseOutputSchema, BackportOutputSchema, ClarificationNeededData, OpenEndedAnalysisData, ErrorData, RebaseData, BackportData
from ymir.common.constants import JiraLabels, JIRA_SEARCH_PATH, RedisQueues
from ymir.common.utils import redis_client
...
def test_make_request_with_retries_rate_limited(fetcher):
    ...
    flexmock(sys.modules['ymir.jira_issue_fetcher.jira_issue_fetcher']).should_receive('logger').and_return(mock_logger)
