...
class SearchJiraIssuesTool(
    Tool[SearchJiraIssuesToolInput, ToolRunOptions, JSONToolOutput[dict[str, list[dict[str, Any]]]]]
):
...
class CreateJiraIssueToolInput(BaseModel):
    ...
    assignee_email: str | None = Field(default=None, description="Assignee email address")
    reporter_email: str | None = Field(default=None, description="Reporter email address")
